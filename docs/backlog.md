...
| 6 | US-004b | **Sector caster: overdraw 1.0x, allocation-free ray loop, fast shader, headless bench** (engine story) | P0 | po-review | Architect re-review #4 (2026-09-24): ARCH OK. Solid-cell fix verified, and the oracle probe dropped from 6,708 to 10 mismatched cells, all oracle-only. PO review next. Must be `done` before US-006 and US-016 |
...
### US-004b Sector caster: overdraw to 1.0x, allocation-free ray loop, fast shader, headless bench  [Priority: P0] [Status: po-review]
