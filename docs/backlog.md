...
| 6 | US-004b | **Sector caster: overdraw 1.0x, allocation-free ray loop, fast shader, headless bench** (engine story) | P0 | arch-review | Rework #2 (2026-09-24): item 1 fixed for real - removed the `skyClosedTop` latch that blocked a later sky segment's own far-ceiling check; column 80 rows 22-25 now correctly report the far ceiling, not sky. Items 2-6 unchanged (already OK per architect re-review #1). Back to architect. Must be `done` before US-006 and US-016 |
