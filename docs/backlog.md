...
| 7 | US-024 | **Engine/game split (D-006)** | P0 | dev | Phases A+B done (programmer, 2026-09-23). Phase C (physics/entities move) next, then Phase D (closing) |
...
### US-024 Engine/game split (D-006)  [Priority: P0] [Status: arch-review]
