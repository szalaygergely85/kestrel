...
| 6 | US-004b | **Sector caster: overdraw 1.0x, allocation-free ray loop, fast shader, headless bench** (engine story) | P0 | testing | PO OK 2026-09-24 (after ARCH OK #4). Tester next: bench ALL CHECKS PASS, shadetest, far ceiling beyond the skylight at the start pose (checklist in section). Must be `done` before US-006 and US-016 |
...
### US-004b Sector caster: overdraw to 1.0x, allocation-free ray loop, fast shader, headless bench  [Priority: P0] [Status: testing]
