...
| 6 | US-004b | **Sector caster: overdraw 1.0x, allocation-free ray loop, fast shader, headless bench** (engine story) | P0 | arch-review | Programmer notes below (2026-09-23); needs ARCH OK before po-review. Must be `done` before US-006 and US-016 |
...
### US-004b Sector caster: overdraw to 1.0x, allocation-free ray loop, fast shader, headless bench  [Priority: P0] [Status: arch-review]
